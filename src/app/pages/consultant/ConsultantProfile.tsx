...
import { User, Mail, Phone, Briefcase, Users, DollarSign, Star, Lock, Trash2, Edit, Calendar, Check } from "lucide-react";
            ...
            <div className="px-8 pb-8">
              <div className="flex flex-col md:flex-row items-start md:items-end gap-6 -mt-16 mb-6">
                <div className="relative">
                  <div className="w-32 h-32 bg-gradient-to-br from-teal-500 to-teal-600 rounded-full flex items-center justify-center text-white text-5xl font-bold border-4 border-white shadow-xl transform hover:scale-105 transition-transform duration-300">
                    {getInitials(formData.fullName || "Financial Consultant")}
                  </div>
                ...
                <div className="flex-1">
                  <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-600 mt-2 mb-2">{formData.fullName || "Financial Consultant"}</h2>
                  <p className="text-teal-600 font-medium mb-4">Financial Consultant</p>
                  <div className="flex flex-wrap gap-3">
                    <span className="mt-2 mb-2 px-4 py-2 bg-teal-100 text-teal-700 rounded-lg text-sm font-medium flex items-center gap-2">
