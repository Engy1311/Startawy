...
import loginImage from "../../assets/c5dab0982181ba976c789e924259b1da6cc1ec63.png";
...
export function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      // Mock login - navigate to role switcher
  ...
  return (
    <div className="min-h-screen flex relative">
      ...
      {/* Left Side - Image */}
      <div className="hidden lg:flex lg:w-[60%] relative overflow-hidden bg-gradient-to-br from-teal-900 via-teal-800 to-teal-900">
